...
class TestApacheLogParser(unittest.TestCase):
    ...
    def testCombinedExample(self):
        ...
        self.assertEqual(apacheLogFileParser.dictify_logline(combined_log_entry),
    ...
    def testCommonExample(self):
        ...
        self.assertEqual(apacheLogFileParser.dictify_logline(common_log_entry),
                        {'remote_host': '127.0.0.1', 'status': '200', 'bytes_sent': '2326'})
    ...
    def testMalformed(self):
        ...
        self.assertNotEqual(apacheLogFileParser.dictify_logline(common_log_entry),
                        {'remote_host': '127.0.0.1', 'status': '200', 'bytes_sent': '2326'})
